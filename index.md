...
> \[!WARNING\] LCr is currently in development so functions and
> vignettes may change. Please come back soon for the next version.
...
Note the following example is for plant species. For help on processing
species in other kingdoms see the vignette [Fungi
workflow](https://stevenpbachman.github.io/LCr/articles/SIS_connect_fungi_workflow.html).
